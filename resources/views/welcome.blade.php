...
@section('content')
    ...
    <!-- Main Hero Content -->
    <div class="container max-w-lg px-2 py-32 mx-auto mt-8 text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center" style="background-image: url('{{ asset('storage/images/futsal.jpg') }}');">
      <h1 class="font-mono text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500 md:text-center sm:leading-none lg:text-5xl">
        <span class="inline md:block">Welcome To Banjarmasin Reservation</span>
      </h1>
        ...
        <div class="flex flex-wrap items-center sm:-mx-3">
          ...
          <div class="w-full md:w-1/2">
            <div class="w-full h-auto overflow-hidden rounded-md shadow-xl sm:rounded-xl">
                <img src="{{ asset('storage/images/kancaputih.png') }}" alt="" />
            </div>
        </div>
        ...
        <div class="flex flex-wrap items-center -mx-3">
            ...
            <div class="w-full lg:max-w-md">
              ...
              <ul>
                <li class="flex items-center py-2 space-x-4 xl:py-3">
                  ...
                  <span class="font-medium text-gray-500">Faster Processing and Reservation</span>
                </li>
                <li class="flex items-center py-2 space-x-4 xl:py-3">
          ...
          <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0">
            <img class="mx-auto sm:max-w-sm lg:max-w-full"
                 src="{{ asset('storage/images/2.png') }}"
                 alt="feature image">
        </div>
